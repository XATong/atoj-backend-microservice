package com.atong.atojbackendquestionservice.controller;


import com.atong.atojbackendcommon.annotation.AuthCheck;
import com.atong.atojbackendcommon.common.BaseResponse;
import com.atong.atojbackendcommon.common.DeleteRequest;
import com.atong.atojbackendcommon.common.ErrorCode;
import com.atong.atojbackendcommon.common.ResultUtils;
import com.atong.atojbackendcommon.constant.UserConstant;
import com.atong.atojbackendcommon.exception.BusinessException;
import com.atong.atojbackendcommon.exception.ThrowUtils;
import com.atong.atojbackendmodel.model.dto.question.*;
...
public class QuestionController {
     ...
     */
    @PostMapping("/list/manage/page")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<QuestionManageVO>> listManageQuestionByPage(@RequestBody QuestionQueryRequest questionQueryRequest) {
        long current = questionQueryRequest.getCurrent();
        long size = questionQueryRequest.getPageSize();
    ...
    /**
     * 分页获取题目提交记录列表（除管理员以及本人外，普通用户只能看到无答案和提交代码的公开信息）
     *
     ...
     * 分页获取题目提交记录（前端展示优化版）
     */
    @PostMapping("/question_submit/page/view")
    public BaseResponse<Page<QuestionSubmitViewVO>> listQuestionSubmitViewByPage(@RequestBody QuestionSubmitQueryRequest questionSubmitQueryRequest){
        long current = questionSubmitQueryRequest.getCurrent();
        long pageSize = questionSubmitQueryRequest.getPageSize();
        Page<QuestionSubmit> questionSubmitPage = questionSubmitService.page(new Page<>(current, pageSize),
                questionSubmitService.getQueryWrapper(questionSubmitQueryRequest));
        return ResultUtils.success(questionSubmitService.getQuestionSubmitVOViewByPage(questionSubmitPage));
    }
